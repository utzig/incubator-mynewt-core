...
static struct test_vectors md5_vectors = {
    .name = "MD5",
    .algo = HASH_ALGO_MD5,
    .digestlen = 16,
    .len = 4,
    .vectors = {
        ...
        },
        {
            ...
            .inlen = 56,
            .digest = "\x82\x15\xef\x07\x96\xa2\x0b\xca"
                      "\xaa\xe1\x16\xd3\x87\x6c\x66\x4a",
        },
        {
            .in = "abcdefghbcdefghicdefghijdefghijkefghijklfghijklmghijklmn"
                  "hijklmnoijklmnopjklmnopqklmnopqrlmnopqrsmnopqrstnopqrstu",
            .inlen = 112,
            .digest = "\x03\xdd\x88\x07\xa9\x31\x75\xfb"
                      "\x06\x2d\xfb\x55\xdc\x7d\x35\x9c",
        },
...
static struct test_vectors sha1_vectors = {
    .name = "SHA-1",
    .algo = HASH_ALGO_SHA1,
    .digestlen = 20,
    .len = 4,
    .vectors = {
        ...
        },
        {
            .in = "abcdefghbcdefghicdefghijdefghijkefghijklfghijklmghijklmn"
                  "hijklmnoijklmnopjklmnopqklmnopqrlmnopqrsmnopqrstnopqrstu",
            .inlen = 112,
            .digest = "\xa4\x9b\x24\x46\xa0\x2c\x64\x5b"
                      "\xf4\x19\xf9\x95\xb6\x70\x91\x25"
                      "\x3a\x04\xa2\x59",
        },
    },
};
...
static struct stream_data streams[] = {
    {
        ...
        .algo = HASH_ALGO_MD5,
        .digestlen = 16,
        .digest = "\x77\x07\xd6\xae\x4e\x02\x7c\x70"
                  "\xee\xa2\xa9\x35\xc2\x29\x6f\x21",
    },
    {
        .name = "SHA-1",
        .algo = HASH_ALGO_SHA1,
        .digestlen = 20,
        .digest = "\x34\xaa\x97\x3c\xd4\xc4\xda\xa4"
                  "\xf6\x1e\xeb\x2b\xdb\xad\x27\x31"
                  "\x65\x34\x01\x6f",
    },
    {
        .name = "SHA-224",
